...
@Component({
  selector: "app-enclos-evenement",
  templateUrl: "./enclos-evenement.component.html",
  styleUrls: ["../../../materialize.min.css"],
})
export class EnclosEvenementComponent implements OnInit, AfterViewInit {
