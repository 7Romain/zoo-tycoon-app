...
@Component({
  selector: "app-espece-evenement",
  templateUrl: "../test-evenement/test-evenement.component.html",
  styles: [],
})
export class EspeceEvenementComponent implements OnInit, AfterViewInit {
